...
function bindHamburger(){
  ...
  btn.addEventListener("click", () => {
    const isOpen = document.querySelector(".filter-bar").classList.contains("is-open");
    isOpen ? closeHamburgerMenu() : openHamburgerMenu();
  });
  backdrop.addEventListener("click", closeHamburgerMenu);
}

function openHamburgerMenu(){
  document.querySelector(".filter-bar").classList.add("is-open");
  document.getElementById("filterBackdrop").classList.add("is-open");
